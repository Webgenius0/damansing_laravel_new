...
@endpush
@section('title', 'How It Work Banner Create')
@section('content')
<div class="app-content content ">
    <!-- General setting Form section start -->
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">How It Work Banner Create</h3>
            <!-- <div>
        ...
        <div class="card-body">
            <form class="form" method="POST" action="{{ route('cms.createOrUpdateForm', ['page' => 'how_it_work', 'section' => 'how_it_work_banner', 'id' => $cmsData->id ?? null]) }}" enctype="multipart/form-data">
                @csrf
