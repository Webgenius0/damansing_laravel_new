...
@endpush
@section('title', 'Create Easy And Watch')
@section('content')
<!-- Card Section -->
<div class="app-content content ">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Easy And Watch</h3>
        </div>
        <div class="card-body">
            <form class="form" method="POST" action="{{  route('cms.createOrUpdateForm', ['page' => 'how_it_work','section' => 'easy_and_watch' ]) }}"
