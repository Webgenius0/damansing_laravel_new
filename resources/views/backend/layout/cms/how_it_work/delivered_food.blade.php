...
@endpush
@section('title', 'Create Delivered Food')
@section('content')
<!-- Card Section -->
<div class="app-content content ">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Delivered Food</h3>
        </div>
        <div class="card-body">
            <form class="form" method="POST" action="{{  route('cms.createOrUpdateForm', ['page' => 'how_it_work','section' => 'delivered_food' ]) }}"
