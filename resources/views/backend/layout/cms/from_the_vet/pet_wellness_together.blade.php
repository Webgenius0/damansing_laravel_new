...
@endpush
@section('title', 'Pet Wellness Create')
@section('content')
<div class="app-content content ">
    <!-- General setting Form section start -->
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Pet Wellness Together</h3>
            <!-- <div>
        ...
        <div class="card-body">
            <form class="form" method="POST" action="{{ route('cms.createOrUpdateForm', ['page' => 'from_the_vet', 'section' => 'pet_wellness_together', 'id' => $cmsData->id ?? null]) }}" enctype="multipart/form-data">
                @csrf
