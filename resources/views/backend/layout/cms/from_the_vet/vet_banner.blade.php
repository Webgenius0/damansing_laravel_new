...
@endpush
@section('title', 'Vet Create')
@section('content')
<div class="app-content content ">
    <!-- General setting Form section start -->
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">From The Vet Banner Create</h3>
            <!-- <div>
        ...
        <div class="card-body">
            <form class="form" method="POST" action="{{ route('cms.createOrUpdateForm', ['page' => 'from_the_vet', 'section' => 'vet_banner', 'id' => $cmsData->id ?? null]) }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-12 col-12">
                        <div class="form-group">
                            ...
                            <textarea type="text" id="description" class="form-control"
                                placeholder="Home Banner Description" name="description" rows="8" hidden>{{ old('description', $cmsData->description ?? '') }}</textarea>
                            @error('description')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
