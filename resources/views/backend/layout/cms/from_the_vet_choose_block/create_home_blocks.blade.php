    ...
    <div class="app-content content ">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Recipes and Nutrition Section</h3>
                <div>
            ...
            <div class="card-body">
                <form class="form" method="POST" action="{{ route('cms.createOrUpdateForm', ['page' => 'from_the_vet_choose_block', 'section' => 'uniquesection', 'id' => $cmsData->id ?? null]) }}" enctype="multipart/form-data">
                    @csrf
