...
@section('title', 'Recipes and Nutration Page')
...
<main class="app-content content">
    <h2 class="section-title">Welcome Choose Blocks</h2>
        ...
        <div class="card-body">
            <div class="table-responsive p-4">
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('cms.get', ['section' => 'create_choose_blocks', 'page' => 'from_the_vet_choose_block']) }}" class="btn btn-primary" type="button">
...
<script>
    $(document).ready(function() {
        let dTable = $('#basic_tables').DataTable({
            ...
            ajax: {
                url: "{{ route('cms.get', ['section' => 'create_home_blocks', 'page' => 'from_the_vet_choose_block']) }}",
                type: "get",
            },
            columns: [{
                    data: 'DT_RowIndex',
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        var truncated = data.length > 30 ? data.substr(0, 30) + '...' : data;
                        return '<span class="description-text" data-description="' + data + '">' + truncated + '</span>';
                    }
                },
                {
                    data: 'status',
    ...
    $(document).ready(function() {
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.description-text', function() {
                ...
                var cleanDescription = stripTags(fullDescription);
                if ($this.hasClass('expanded')) {
                    $this.removeClass('expanded');
                    $this.text(cleanDescription.substr(0, 30) + '...');
                } else {
                    $this.addClass('expanded');
                    $this.text(cleanDescription);
                }
            });
        });
