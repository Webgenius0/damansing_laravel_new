...
<main class="app-content content">
    <h2 class="section-title">Welcome Recipes</h2>
        ...
        <div class="card-body">
            <div class="table-responsive p-4">
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('cms.get', ['section' => 'create_new', 'page' => 'recipesAndNutration']) }}" class="btn btn-primary" type="button">
                        <span>Add Card</span>
                    </a>
                </div>
...
<script>
    $(document).ready(function() {
        let dTable = $('#basic_tables').DataTable({
            ...
            ajax: {
                url: "{{ route('cms.get', ['section' => 'create_home_blocks', 'page' => 'recipesAndNutration']) }}",
                type: "get",
            },
            columns: [{
                    data: 'DT_RowIndex',
