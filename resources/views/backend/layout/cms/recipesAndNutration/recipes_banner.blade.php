...
@endpush
@section('title', 'Recipes Banner Create')
@section('content')
<div class="app-content content ">
    <!-- General setting Form section start -->
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Recipes Banner Create</h3>
            <!-- <div>
        ...
        <div class="card-body">
            <form class="form" method="POST" action="{{ route('cms.createOrUpdateForm', ['page' => 'recipesAndNutration', 'section' => 'recipes_banner', 'id' => $cmsData->id ?? null]) }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <textarea type="text" id="description" class="form-control"
                        placeholder="Home Banner Description" name="description" rows="8" hidden></textarea>
                    @error('description')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
