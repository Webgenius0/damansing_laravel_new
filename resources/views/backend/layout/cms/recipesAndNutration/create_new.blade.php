...
<div>
    <div class="app-content content ">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form" method="POST" action="{{  route('cms.createOrUpdateForm', ['page' => 'recipesAndNutration','section' => 'card_header', 'id' => $cmsData->id ?? null ]) }}"
                        ...
                        <div class="col-md-12 col-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" id="description" class="form-control"
                                    placeholder="Home Banner Description" name="description" rows="8" ></textarea>
                                @error('description')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
...
<div class="app-content content ">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div>
                <a href="{{route('cms.get', ['section' => 'card_index', 'page' => 'recipesAndNutration']) }}" class="btn btn-primary" type="button">
                    <span>Card List</span>
                </a>
            </div>
        ...
        <div class="card-body">
            <form class="form" method="POST" action="{{  route('cms.createOrUpdateForm', ['page' => 'recipesAndNutration','section' => 'uniquesection', ]) }}"
                enctype="multipart/form-data">
                @csrf
                <input type="text" hidden name="" id="" value="unique">
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <label for="description">Description</label>
                            <textarea name="description" class="ck-editor form-control @error('description') is-invalid @enderror">{{ old('short_description') }}</textarea>
                            @error('description')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
