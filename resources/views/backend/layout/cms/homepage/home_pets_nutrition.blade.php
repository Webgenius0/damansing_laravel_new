...
<div class="app-content content ">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="form" method="POST" action="{{ route('cms.createOrUpdateForm', ['page' => 'homepage', 'section' => 'home_pets_nutrition', 'id' => $cmsData->id ?? null]) }}" enctype="multipart/form-data">
                @csrf
