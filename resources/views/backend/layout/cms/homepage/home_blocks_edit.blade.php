...
@endpush
@section('title', 'Create Block Section')
@section('content')
    <div class="app-content content ">
        
    <div class="card">
            <div class="card-header">
                <h3 class="card-title">Nutritious & Delicious Meals</h3>
                <!-- <div>
            ...
            <div class="card-body">
                <form class="form" method="POST" action="{{  route('cms.createOrUpdateForm', ['page' => 'homepage','section' => 'home_blocks_edit', 'id' => $cmsData->id ?? null ]) }}"
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Create Block Section</h3>
                <div>
